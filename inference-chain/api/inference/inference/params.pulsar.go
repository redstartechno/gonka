...
var file_inference_inference_params_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfe, 0x07, 0x0a, 0x06,
	...
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x2f, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0xb0, 0x07, 0x0a,
	...
	0x61, 0x72, 0x64, 0x69, 0x61, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x22,
	0xdf, 0x04, 0x0a, 0x10, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x6f, 0x6d, 0x69, 0x63, 0x73, 0x50, 0x61,
	...
	0x74, 0x61, 0x67, 0x65, 0x12, 0x59, 0x0a, 0x1a, 0x74, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x77, 0x61,
	...
	0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x44,
	0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c, 0x52, 0x17, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x77, 0x61, 0x72,
	...
	0x63, 0x51, 0x75, 0x61, 0x6c, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2e,
	...
	0x6f, 0x64, 0x12, 0x37, 0x0a, 0x18, 0x74, 0x6f, 0x70, 0x5f, 0x6d, 0x69, 0x6e, 0x65, 0x72, 0x5f,
	0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x15, 0x74, 0x6f, 0x70, 0x4d, 0x69, 0x6e, 0x65, 0x72, 0x56, 0x65,
...
var file_inference_inference_params_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
...
var file_inference_inference_params_proto_depIdxs = []int32{
	...
	7,  // 11: inference.inference.GenesisOnlyParams.max_individual_power_percentage:type_name -> inference.inference.Decimal
	7,  // 12: inference.inference.GenesisOnlyParams.genesis_guardian_multiplier:type_name -> inference.inference.Decimal
	7,  // 13: inference.inference.TokenomicsParams.subsidy_reduction_interval:type_name -> inference.inference.Decimal
	7,  // 14: inference.inference.TokenomicsParams.subsidy_reduction_amount:type_name -> inference.inference.Decimal
	7,  // 15: inference.inference.TokenomicsParams.current_subsidy_percentage:type_name -> inference.inference.Decimal
	7,  // 16: inference.inference.TokenomicsParams.top_reward_allowed_failure:type_name -> inference.inference.Decimal
	7,  // 17: inference.inference.EpochParams.poc_slot_allocation:type_name -> inference.inference.Decimal
	7,  // 18: inference.inference.ValidationParams.false_positive_rate:type_name -> inference.inference.Decimal
	7,  // 19: inference.inference.ValidationParams.pass_value:type_name -> inference.inference.Decimal
	7,  // 20: inference.inference.ValidationParams.min_validation_average:type_name -> inference.inference.Decimal
	7,  // 21: inference.inference.ValidationParams.max_validation_average:type_name -> inference.inference.Decimal
	7,  // 22: inference.inference.ValidationParams.min_validation_halfway:type_name -> inference.inference.Decimal
	7,  // 23: inference.inference.ValidationParams.miss_percentage_cutoff:type_name -> inference.inference.Decimal
	7,  // 24: inference.inference.ValidationParams.miss_requests_penalty:type_name -> inference.inference.Decimal
	7,  // 25: inference.inference.ValidationParams.invalid_reputation_preserve:type_name -> inference.inference.Decimal
	7,  // 26: inference.inference.ValidationParams.bad_participant_invalidation_rate:type_name -> inference.inference.Decimal
	7,  // 27: inference.inference.ValidationParams.invalidation_h_threshold:type_name -> inference.inference.Decimal
	7,  // 28: inference.inference.ValidationParams.downtime_good_percentage:type_name -> inference.inference.Decimal
	7,  // 29: inference.inference.ValidationParams.downtime_bad_percentage:type_name -> inference.inference.Decimal
	7,  // 30: inference.inference.ValidationParams.downtime_h_threshold:type_name -> inference.inference.Decimal
	7,  // 31: inference.inference.ValidationParams.downtime_reputation_preserve:type_name -> inference.inference.Decimal
	7,  // 32: inference.inference.ValidationParams.quick_failure_threshold:type_name -> inference.inference.Decimal
	7,  // 33: inference.inference.ValidationParams.binom_test_p0:type_name -> inference.inference.Decimal
	7,  // 34: inference.inference.PoCModelParams.ffn_dim_multiplier:type_name -> inference.inference.Decimal
	7,  // 35: inference.inference.PoCModelParams.norm_eps:type_name -> inference.inference.Decimal
	7,  // 36: inference.inference.PoCModelParams.r_target:type_name -> inference.inference.Decimal
	7,  // 37: inference.inference.PocParams.weight_scale_factor:type_name -> inference.inference.Decimal
	5,  // 38: inference.inference.PocParams.model_params:type_name -> inference.inference.PoCModelParams
	7,  // 39: inference.inference.CollateralParams.slash_fraction_invalid:type_name -> inference.inference.Decimal
	7,  // 40: inference.inference.CollateralParams.slash_fraction_downtime:type_name -> inference.inference.Decimal
	7,  // 41: inference.inference.CollateralParams.downtime_missed_percentage_threshold:type_name -> inference.inference.Decimal
	7,  // 42: inference.inference.CollateralParams.base_weight_ratio:type_name -> inference.inference.Decimal
	7,  // 43: inference.inference.CollateralParams.collateral_per_weight_unit:type_name -> inference.inference.Decimal
	7,  // 44: inference.inference.BitcoinRewardParams.decay_rate:type_name -> inference.inference.Decimal
	7,  // 45: inference.inference.BitcoinRewardParams.utilization_bonus_factor:type_name -> inference.inference.Decimal
	7,  // 46: inference.inference.BitcoinRewardParams.full_coverage_bonus_factor:type_name -> inference.inference.Decimal
	7,  // 47: inference.inference.BitcoinRewardParams.partial_coverage_bonus_factor:type_name -> inference.inference.Decimal
	7,  // 48: inference.inference.DynamicPricingParams.stability_zone_lower_bound:type_name -> inference.inference.Decimal
	7,  // 49: inference.inference.DynamicPricingParams.stability_zone_upper_bound:type_name -> inference.inference.Decimal
	7,  // 50: inference.inference.DynamicPricingParams.price_elasticity:type_name -> inference.inference.Decimal
	7,  // 51: inference.inference.BandwidthLimitsParams.kb_per_input_token:type_name -> inference.inference.Decimal
	7,  // 52: inference.inference.BandwidthLimitsParams.kb_per_output_token:type_name -> inference.inference.Decimal
	7,  // 53: inference.inference.ConfirmationPoCParams.alpha_threshold:type_name -> inference.inference.Decimal
	7,  // 54: inference.inference.ConfirmationPoCParams.slash_fraction:type_name -> inference.inference.Decimal
