...
const (
	...
	Msg_SubmitPocArtifactBatchesV2_FullMethodName       = "/inference.inference.Msg/SubmitPocArtifactBatchesV2"
...
func (c *msgClient) SubmitPocArtifactBatchesV2(ctx context.Context, in *MsgSubmitPocArtifactBatchesV2, opts ...grpc.CallOption) (*MsgSubmitPocArtifactBatchesV2Response, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SubmitPocArtifactBatchesV2_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SubmitPocArtifactBatchesV2(context.Context, *MsgSubmitPocArtifactBatchesV2) (*MsgSubmitPocArtifactBatchesV2Response, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitPocArtifactBatchesV2 not implemented")
}
...
func _Msg_SubmitPocArtifactBatchesV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SubmitPocArtifactBatchesV2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
